...
const Paths = {
  ...
  JS: {
    ...
    CONFIG_NAVBAR_VERTICAL: ['js/theme/config.navbar-vertical.js'],
    PLUGINS: [],
  },
  SCSS: {
    ALL: 'scss/**/*.scss',
  ...
  DEPENDENCIES: {
    ...
    'jquery.mb.ytplayer': {
      FROM: [
        'node_modules/jquery.mb.ytplayer/dist/css/jquery.mb.YTPlayer.min.css',
    ...
    'select2-theme': {
      FROM: [
        ...
        'node_modules/@ttskch/select2-bootstrap4-theme/src/_layout.scss',
        'node_modules/@ttskch/select2-bootstrap4-theme/src/_multiple.scss',
        'node_modules/@ttskch/select2-bootstrap4-theme/src/_single.scss',
        'node_modules/@ttskch/select2-bootstrap4-theme/src/select2-bootstrap4.scss',
      ],
      TO: lib,
    },
    fullcalendar: {
    ...
    dayjs: {
      FROM: 'node_modules/dayjs/dayjs.min.js',
      TO: lib,
    },
  },
  GENERATED: [
...
gulp.task('js:config-vertical-navbar', () =>
  gulp
    .src(Paths.JS.CONFIG_NAVBAR_VERTICAL)
    .pipe(eslint({ fix: true }))
    .pipe(eslint.format())
    .pipe(eslint.failAfterError())
...
gulp.task(
  'js',
  gulp.parallel('js:bootstrap', 'js:theme', 'js:config-vertical-navbar')
);
...
gulp.task('watch', () => {
  ...
  gulp.watch(
    Paths.JS.CONFIG_NAVBAR_VERTICAL,
    gulp.series('js', (done) => {
      reload();
      done();
    })
